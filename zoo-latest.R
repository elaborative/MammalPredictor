...
if(!require(simputation)) install.packages("simputation", repos = "http://cran.us.r-project.org")
...
predictgenusac <- function(trainDS,testRow,impute){
...
## ----measurebasicfinal--------------------------------------------------------------------------------
measure_df10 <- measuremodel(cm,"10- Random Forest","Basic Model - Order - FINAL","Order")
...
measure_df11 <- measuremodel(cm,"11- Random Forest","Advanced Model - Order - FINAL","Order")
...
measure_df12 <- measuremodel(cm,"12- Random Forest","Advanced Model - Family - FINAL","Family")
...
measure_df13 <- measuremodel(cm,"13- Random Forest","Advanced Model - Genus -  FINAL","Genus")
